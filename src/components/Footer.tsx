...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/SahilSharma950',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/sahil-sharma-229a76248',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'mailto:sahilsharma32520@gmail.com',
      icon: (
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              MERN Stack Developer building scalable web and backend systems for web and mobile applications.
            </p>
          </div>
            ...
            <div className="flex gap-4">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  className="p-3 glass-effect rounded-lg hover:border-cyan-500/50 transition-all duration-300 group"
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-center md:text-left">
              Copyright {currentYear} Sahil Sharma. All rights reserved.
            </p>
